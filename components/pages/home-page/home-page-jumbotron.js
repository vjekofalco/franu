    ...
    >
      <JumbotronContent>
        <HomePageJumbotronText live={live}>
          ...
          <HeadlineTernarry color={grayscale3} marginTop={2}>
            {f("jumbotron.subTitle")}
          </HeadlineTernarry>
          <div>
            <ButtonPrimary
              big
              marginTop={3}
              marginBottom={1}
              onClick={() => scrollToView("contact-us-form")}
            >
              {f("jumbotron.cta")}
            </ButtonPrimary>
            <Text
              weight={600}
              onClick={() => scrollToView("find-inspiration")}
        ...
        <HomePageJumbotronImageWrapper live={live}>
          <HomePageJumbotronImageWrapperInner>
            <ImageOptimized
              relativeUrl="home-page/jumbotron-image.jpg"
              alt={"Kitchens photo"}
              width={552}
              height={392}
            />
