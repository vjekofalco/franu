  ...
  <>
    <PropositionWrapper>
      <PropositionHeadlineWrapper>
        <Design />
        <HeadlineTernarry marginLeft={1}>
          {f("common.requestForm.valueProposition.one.title")}
        </HeadlineTernarry>
      </PropositionHeadlineWrapper>
      <Text>{f("common.requestForm.valueProposition.one.description")}</Text>
    </PropositionWrapper>
    <PropositionWrapper>
      <PropositionHeadlineWrapper>
        <Medal />
        <HeadlineTernarry marginLeft={1}>
          {f("common.requestForm.valueProposition.two.title")}
        </HeadlineTernarry>
      </PropositionHeadlineWrapper>
      <Text>{f("common.requestForm.valueProposition.two.description")}</Text>
    </PropositionWrapper>
    <PropositionWrapper>
      <PropositionHeadlineWrapper>
        <DeliveryTruck />
        <HeadlineTernarry marginLeft={1}>
          {f("common.requestForm.valueProposition.three.title")}
        </HeadlineTernarry>
      </PropositionHeadlineWrapper>
      <Text>{f("common.requestForm.valueProposition.three.description")}</Text>
    </PropositionWrapper>
    <PropositionWrapper>
      <PropositionHeadlineWrapper>
        <Money />
        <HeadlineTernarry marginLeft={1}>
          {f("common.requestForm.valueProposition.four.title")}
        </HeadlineTernarry>
      </PropositionHeadlineWrapper>
      <Text>{f("common.requestForm.valueProposition.four.description")}</Text>
    </PropositionWrapper>
