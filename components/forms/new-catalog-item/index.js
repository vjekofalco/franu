...
export const NewCatalogItemForm = () => {
  ...
  const categoriesSelectOptions = catalogCategories.map((cc) => ({
    ...cc,
    value: cc.id,
  }))
  const energyEfficiencySelectOptions = energyEfficiencyLabels.map((e) => ({
    ...e,
    value: e.id,
  }))
  ...
  return (
    <>
      {submitted && (
        <Text marginTop={1} color={support1}>
          Artikal <span style={{ fontWeight: 600 }}>{itemName}</span> je
          uspjesno dodan.
        </Text>
      )}
      <Formik
      ...
      >
        {(props) => (
          <Form>
            ...
            <Text size={1.5} marginBottom={0.5} color={brown} weight={600}>
              Dodatne funkcionalnosti
            </Text>
            <Text>
              <span style={{ fontWeight: 600 }}>Primjer: </span> Bestecksystem -
              Besteckkorb
            </Text>
            <FieldArray
              ...
              render={(arrayHelpers) => (
                <div>
                  ...
                  <ButtonSecondary
                    type="button"
                    marginTop={2}
                    onClick={() => arrayHelpers.push({ ...initFunctionality })}
                  >
            ...
            />
            <SubmitWrapper>
              <ButtonBrown medium type="submit">
                Unesi artikal
              </ButtonBrown>
            </SubmitWrapper>
          </Form>
